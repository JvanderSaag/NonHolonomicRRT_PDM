...
MPC implemented using existing mode authored by Huiming Zhou. The code was modified in order to use paths generated by the global planners from our implementation of RRT. (https://github.com/zhm-real/MotionPlanning)
