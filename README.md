...
### Plots
This folder contains some of the saved plots and videos.
...
MPC implemented using existing mode authored by Huming Zhou. The code was modified in order to use paths generated by the global planners from our implementation of RRT. (https://github.com/zhm-real/MotionPlanning)
