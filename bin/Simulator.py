...
def run_sim(scenario, path_points, path_yaw):
	...
	pixel_scaling = 1000/20 # 1 meter is 1000/20 pixels. Hence a 20*20 window would be 1000*1000 pixels
	...
	for i in range(len(path_points)):
	    ...
	    for obstacle in range obstacles:
		    ...
		    pygame.draw.polygon(window, (150,150,150), list(zip(xs,ys)))
	    ...
	    xs, ys = obstacle.exterior.coords.xy
	    pygame.draw.polygon(window, (0,0,255), list(zip(xs,ys)))
